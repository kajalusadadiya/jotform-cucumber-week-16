...
public class HomePage extends Utility {
    ...
    @FindBy(xpath = "//div[@class='jfThankYou-imageWrapper']")
    ...
    public void selectDate(String date) {
        sendTextToElement(dateBox, date);
    ...
    public String getSubmissionText() {
        String txt = getTextFromElement(submissionMessage);
        //log.info("Getting submission message: " + submissionMessage.toString());
        return txt;
    }
}
